...
public class NewsDetailAcitivity extends Activity
{
	...
	private void initEvent() {
		...
		OnClickListener listener = new OnClickListener() {
			int textSizeIndex = 2;// 0. 超大号 1,大号  2 正常  3 小号  4 超小号  设置默认为正常
			...
			private void showChangeTextSizeDialog() {
				...
				//设置单选框，第二个参数为默认字体大小，DialogInterface.OnClickListener（）   因为前边已经用过 OnClickListener（）  故 此处加前缀
	...
	private void initData() {
		//获取数据  获取intent--》  获取intent中的url
		String url = getIntent().getStringExtra("newsurl");
		//TextUtils  android  用于处理简单内容
